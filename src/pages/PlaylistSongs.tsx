...
export function PlaylistSongs() {
    ...
    const { updateUser, search } = useStore()
    ...
    return (
        search === '' ?
            ...
            <section className="song-details-content">
                ...
                <div className="song-content-main-wrapper">
                    <Sidebar />
                    <section style={{ display: "grid", gridAutoFlow: "row", gridGap: "1.8rem", paddingTop: "2rem", justifyContent: "center", alignContent: "flex-start" }}>
                        {playlist?.playlistSongs.filter((object: any) => object.song.title.toUpperCase().includes(search.toUpperCase())).map((object: any) => {
                            return (
                                <div className="music-card" style={{ backgroundColor: "rgb(248, 138, 83)" }} >
                                    <iframe width="900px" height="200px" scrolling="no" frameBorder="no" allow="autoplay" src={object.song.src}></iframe>
